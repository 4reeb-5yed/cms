      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            ...
            {settings.tagline && (
              <p className="text-stone/70 text-sm leading-relaxed">{settings.tagline}</p>
            )}
          </div>
              ...
              {navigation.map((item) => (
                <li key={item.label}>
                  <Link
                    ...
                    className="text-sm text-stone/70 hover:text-stone transition-colors duration-100"
            ...
            <div className="flex gap-4">
              {settings.socialLinks.map((link) => (
                <a
                  ...
                  className="text-stone/70 hover:text-stone transition-colors duration-100"
        ...
        {settings.footerText && (
          <div className="mt-12 pt-8 border-t border-stone/10">
            <p className="text-xs font-mono text-stone/50">{settings.footerText}</p>
          </div>
        )}
      </div>
    </footer>
