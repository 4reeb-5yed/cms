        ...
        <div className="max-w-2xl mx-auto px-6">
          ...
          <div className="mt-16 pt-8 border-t border-ink/10">
            ...
            <div className="flex flex-wrap gap-6 items-center">
              <a href="mailto:areeb.syed1@outlook.com" className="flex items-center gap-2 text-ember hover:underline">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                areeb.syed1@outlook.com
              </a>
              <a href="mailto:4reeb.5yed@gmail.com" className="flex items-center gap-2 text-ink/70 hover:text-ink">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                4reeb.5yed@gmail.com
              </a>
              <a href="https://github.com/4reeb-5yed" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-ink/70 hover:text-ink">
              ...
              <a href="https://www.linkedin.com/in/areeb-syed-b19491245" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-ink/70 hover:text-ink">
